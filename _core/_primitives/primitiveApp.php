...
{ 
	...
	private function loadController( $controllerName, $parentApp, $urlData=null )
	{
		...
		if ( file_exists( $fileForInclusion ) ){
			...
			$this->{$controllerName.'Controller'} = $controllerClassName::create( $controllerName, $parentApp, $urlData );
